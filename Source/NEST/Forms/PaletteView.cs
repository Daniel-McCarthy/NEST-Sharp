...
namespace NEST.Forms
{
    ...
    {
        //Available palettes to load into the palette viewer.
        ...
        public Color[] greyScalePalette = { new Color(0x3A, 0x3A, 0x3A), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x20, 0x20, 0x20), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0xD6, 0xD6, 0xD6), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x40, 0x40, 0x40), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0xFF, 0xFF, 0xFF), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0xC4, 0xC4, 0xC4), new Color(0x12, 0x12, 0x12), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xFF, 0xFF, 0xFF), new Color(0xE9, 0xE9, 0xE9), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00) };
        public Color[] pinkScalePalette = { new Color(0x9B, 0x7C, 0x7C), new Color(0x38, 0x15, 0x6D), new Color(0x36, 0x00, 0x82), new Color(0x21, 0x09, 0x7E), new Color(0x67, 0x06, 0x7E), new Color(0x9A, 0x01, 0x3E), new Color(0xA2, 0x00, 0x00), new Color(0x9D, 0x00, 0x00), new Color(0xAB, 0x25, 0x55), new Color(0xA9, 0x24, 0x33), new Color(0x7C, 0x45, 0x95), new Color(0x6B, 0x23, 0x83), new Color(0x3D, 0x00, 0x38), new Color(0x20, 0x00, 0x00), new Color(0x20, 0x00, 0x00), new Color(0x20, 0x00, 0x00), new Color(0xEA, 0xD8, 0xD8), new Color(0x77, 0x58, 0xDC), new Color(0x7A, 0x48, 0xFF), new Color(0x84, 0x3D, 0xFF), new Color(0xE8, 0x22, 0xF0), new Color(0xFF, 0x24, 0x98), new Color(0xFF, 0x3F, 0x81), new Color(0xF5, 0x13, 0x76), new Color(0xC1, 0x5B, 0xAC), new Color(0xA5, 0x7A, 0x92), new Color(0xB3, 0x74, 0x9E), new Color(0x83, 0x50, 0xA0), new Color(0x6B, 0x34, 0xA5), new Color(0x20, 0x00, 0x00), new Color(0x20, 0x00, 0x00), new Color(0x20, 0x00, 0x00), new Color(0xFE, 0xF6, 0xF6), new Color(0xA6, 0xA4, 0xFF), new Color(0xA7, 0x8F, 0xFF), new Color(0xA7, 0x7D, 0xFF), new Color(0xF8, 0x7C, 0xFF), new Color(0xFF, 0x8A, 0xD2), new Color(0xFF, 0x6E, 0x89), new Color(0xFF, 0x6E, 0x66), new Color(0xE9, 0x8C, 0xC2), new Color(0xCC, 0x9E, 0xBF), new Color(0xD8, 0x9E, 0xDD), new Color(0xB5, 0x7D, 0xE1), new Color(0x81, 0x62, 0x79), new Color(0x78, 0x5E, 0x5E), new Color(0x20, 0x00, 0x00), new Color(0x20, 0x00, 0x00), new Color(0xFE, 0xF6, 0xF6), new Color(0xD1, 0xD4, 0xFF), new Color(0xD8, 0xCD, 0xFF), new Color(0xD6, 0xC5, 0xFF), new Color(0xFB, 0xCA, 0xFF), new Color(0xFF, 0xCF, 0xED), new Color(0xFF, 0xD1, 0xCF), new Color(0xFF, 0xBA, 0xB1), new Color(0xFF, 0xBF, 0xCA), new Color(0xCB, 0xAB, 0xE6), new Color(0xEF, 0xB8, 0xF6), new Color(0xD1, 0xBE, 0xBC), new Color(0xAF, 0xA1, 0xAA), new Color(0xDA, 0xDA, 0xDA), new Color(0x20, 0x00, 0x00), new Color(0x20, 0x00, 0x00) };
        ...
        public PaletteView()
        {
            ...
            addPalette("PinkScale Palette", pinkScalePalette);
        }

        /*
         * Loads the colors from a palette index onto the palette picture boxes for display.
         */
        ...
        /*
         * If a listbox palette is selected, the palette will be drawn to the picture boxes. Otherwise if there is no selection, all picture boxes will be grey.
         */
        ...
        /*
         * Adds a name and palette to the palette lists for selection.
         */
        ...
        /*
         * Applies the selected palette to the ppu to be used in active emulation.
         */
