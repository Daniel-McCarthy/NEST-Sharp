...
namespace NEST.Forms
{
    public partial class PaletteView : Form
    {
        ...
        public Color[] pinkScalePalette = { new Color(0x7C, 0x7C, 0x7C), new Color(0x58, 0x34, 0x9C), new Color(0x5E, 0x0B, 0xC3), new Color(0x34, 0x09, 0xC0), new Color(0x81, 0x06, 0x97), new Color(0xAE, 0x01, 0x49), new Color(0xBA, 0x00, 0x00), new Color(0x9D, 0x00, 0x00), new Color(0xAB, 0x25, 0x55), new Color(0xAA, 0x44, 0x1D), new Color(0x93, 0x45, 0xA6), new Color(0x91, 0x23, 0x9B), new Color(0x5D, 0x00, 0x52), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0xD1, 0xD1, 0xD1), new Color(0x6D, 0x73, 0xF7), new Color(0x7A, 0x5D, 0xFF), new Color(0x84, 0x3D, 0xFF), new Color(0xE8, 0x22, 0xF0), new Color(0xFF, 0x24, 0x98), new Color(0xFF, 0x3F, 0x81), new Color(0xF5, 0x13, 0x76), new Color(0xC1, 0x5B, 0xAC), new Color(0xA6, 0x5C, 0x75), new Color(0xB3, 0x74, 0x9E), new Color(0x7F, 0x6A, 0xA0), new Color(0x6B, 0x34, 0xA5), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0xFE, 0xFF, 0xFF), new Color(0x93, 0xA4, 0xFF), new Color(0xA7, 0x8F, 0xFF), new Color(0xA7, 0x7D, 0xFF), new Color(0xF8, 0x7C, 0xFF), new Color(0xFF, 0x8A, 0xD2), new Color(0xFF, 0x6E, 0x89), new Color(0xFF, 0x6E, 0x66), new Color(0xE9, 0x8C, 0xC2), new Color(0xB1, 0x9D, 0xAA), new Color(0xD8, 0x9E, 0xDD), new Color(0xC6, 0xA6, 0xAA), new Color(0x81, 0x62, 0x79), new Color(0x5E, 0x5E, 0x5E), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00), new Color(0xFE, 0xFF, 0xFF), new Color(0xAE, 0xD4, 0xFF), new Color(0xD8, 0xCD, 0xFF), new Color(0xD6, 0xC5, 0xFF), new Color(0xFB, 0xCA, 0xFF), new Color(0xFF, 0xCF, 0xED), new Color(0xFF, 0xD1, 0xCF), new Color(0xFF, 0xBA, 0xB1), new Color(0xFF, 0xBC, 0xB0), new Color(0xCB, 0xAB, 0xE6), new Color(0xEF, 0xB8, 0xF6), new Color(0xD1, 0xBE, 0xBC), new Color(0xAF, 0xA1, 0xAA), new Color(0xDA, 0xDA, 0xDA), new Color(0x00, 0x00, 0x00), new Color(0x00, 0x00, 0x00) };
